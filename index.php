...
<div class="header-2">
    ...
    <div class="icons">
        ...
        <a href="ShoppingCart.php"  class="fas fa-shopping-cart"><span><?php
           if(isset($_SESSION['cart'])){
              $count=count($_SESSION['cart']);
...
<h1 class="heading"> <span>New products</span> </h1>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="overlay">
            ...
            <form action="index.php#arrival" method="POST">
            ...
            <a href="inner.php?id=<?=$product['id']?>#arrival" style="--i:3;" class="fas fa-search"></a>
        </div>
    </div>
     <?php
     endforeach;
